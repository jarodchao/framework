 ...
 * @date: 2020-05-19
 */
public class EmptyValidator extends ConditionValidator {

    private EmptyValidator(Condition condition) {
        super(condition);
    }

    public static EmptyValidator of(ErrorInfo errorInfo, Object object) {
